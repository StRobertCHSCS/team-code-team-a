...
void loop() {     // repeat in a loop
  ...
  prizm.setGreenLED(HIGH);      // turn the GREEN LED on
    delay(50);                  // wait here for 500ms (0.5 seconds)
  ...
  prizm.setGreenLED(LOW);       // turn the GREEN LED off
     delay(50);                  // wait here for 500ms (0.5 seconds)
  prizm.setGreenLED(HIGH);      // turn the GREEN LED on
    delay(50);                  // wait here for 500ms (0. seconds)
  prizm.setGreenLED(LOW);       // turn the GREEN LED off
    delay(50);                  // wait here for 500ms (0.5 seconds)
  ...
  prizm.setMotorPower(5,-76);   // spin Motor 1 CCW at 25% power
  ...
  prizm.setMotorPower(1,0);     // stop motor (coast to stop);
   delay(1000);                  // After stopping, wait here for 10 seconds, then repeat
