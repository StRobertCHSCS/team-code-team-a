...
void loop()  {
  ...
  prizm.setMotorDegree(1,360,405);   // Spin DC motor 1 at a constant 360 degrees per second and stop when encoder count reaches 1440
  ...
  prizm.setMotorDegree(1,-360,-1080);      // Spin DC motor at 360 degrees per second back to encoder position "0".   
